            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="nama_pt" id="namapt" value="<?php echo $nama_pt ?>" readonly>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="nomor_kontrak" id="nomorkontrak" value="<?php echo $nomor_kontrak?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Vendor *</label>
                        <input class="form-control" type="text" name="vendor" id="vendor" value="<?php echo $vendor?>" readonly>
                    </div>
                </div>
            </div>
        </div>
